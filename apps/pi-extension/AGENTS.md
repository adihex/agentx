...
| `package.json`       | Manifest `@agentx/pi-extension`; all scripts are no-op echoes (no build/test). Declares the `@agentx/adp` workspace dep, pi runtime deps, and `typebox`.                                                                                                                                                                                                                |
